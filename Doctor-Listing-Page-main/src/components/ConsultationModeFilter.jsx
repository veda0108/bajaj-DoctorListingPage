function ConsultationModeFilter({ currentMode, onChange, isExpanded, toggleSection }) {
    return (
        ...
        {isExpanded && (
          <div className="mt-3 space-y-3 pl-1">
            <label className="flex items-center space-x-3 cursor-pointer group">
              ...
              <span className="text-gray-700 group-hover:text-blue-600 transition-colors">Video Consult</span>
            </label>
            <label className="flex items-center space-x-3 cursor-pointer group">
              <div className="relative">
                <input
              ...
              <span className="text-gray-700 group-hover:text-blue-600 transition-colors">In Clinic</span>
            </label>
            <label className="flex items-center space-x-3 cursor-pointer group">
              <div className="relative">
                <input
